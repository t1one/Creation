...
public abstract class BaseAc extends FragmentActivity {
    ...
    protected void initActionBar() {
        ...
        mActionBarBack = (ImageView) view.findViewById(R.id.actionbar_back);
        mActionBarTitle = (TextView) view.findViewById(R.id.actionbar_title);
        mActionBarSetting = (ImageView) view.findViewById(R.id.actionbar_setting);
    ...
    public boolean checkNetwork() {
        boolean isNetworkAvailable = DeviceUtils.checkNet(getApplicationContext());
    ...
    public View showEmptyView(ViewGroup rootView) {
        return showEmptyView(rootView, "", "", false);
    }

    public View showEmptyView(ViewGroup rootView, boolean hide) {
        return showEmptyView(rootView, "", "", hide);
    }

    /**
     * 显示无信息提示 rootView 需要替换的viewgroup tips 无信息提示语
     *
     * @param rootView 替换成empty页面的布局
     * @param cause    主提示语
     * @param hint     次要提示语
     * @param hide     是否隐藏重载按钮
     */
    public View showEmptyView(ViewGroup rootView, String cause, String hint, boolean hide) {
     ...
     * @param impl
     */
    protected void baseDialog(final Context context, final String text, final BackDialogImpl impl) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_base, null);
        TextView tv_message = (TextView) view.findViewById(R.id.tv_message);
        Button btn_ok = (Button) view.findViewById(R.id.btn_ok);
        Button btn_cancel = (Button) view.findViewById(R.id.btn_cancel);
     ...
     * 弹窗按钮功能控制接口
     */
    public interface BackDialogImpl {
        //确定按钮
        void clickOk();
